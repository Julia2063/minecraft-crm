...
export const Settings = () => {
    ...
    return (
        <div className='flex w-full flex-col items-center justify-center py-[20px] gap-[20px]' >
          <SettingsForm data={user} />
        {userRole === 'executor_admin' && (
          <div className='flex w-2/3 flex-col justify-center py-[20px] shadow-md h-max rounded-lg border-[1px]'>
            <UserTableHeader />
            {users?.map((el, i) => (
              <UserLine 
                data={el} 
